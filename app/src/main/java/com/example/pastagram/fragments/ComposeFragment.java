        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (description.isEmpty()) {
                    Toast.makeText(getContext(), "Description should not be empty", Toast.LENGTH_SHORT).show();
                    return;
                }
        ...
        post.saveInBackground(new SaveCallback() {
            ...
            public void done(ParseException e) {
                if (e == null) {
                    ...
                    Toast.makeText(getContext(), "Post has been shared successfully", Toast.LENGTH_SHORT).show();
                    etDescription.setText("");
                    ivPostImage.setImageResource(0);
                } else {
                    Log.e(TAG, "Error while saving: ", e);
                    Toast.makeText(getContext(), "Post share failed", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
