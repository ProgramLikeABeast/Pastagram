        ...
        post.saveInBackground(new SaveCallback() {
            ...
            public void done(ParseException e) {
                if (e == null) {
                    ...
                    Toast.makeText(MainActivity.this, "Post has been shared successfully", Toast.LENGTH_SHORT).show();
                    etDescription.setText("");
                    ivPostImage.setImageResource(0);
                } else {
                    Log.e(TAG, "Error while saving: ", e);
                    Toast.makeText(MainActivity.this, "Post share failed", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
